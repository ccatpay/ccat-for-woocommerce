 ...
 * @since 1.0.0
 */
final class WC_Gateway_CCat_Icash_Blocks_Support extends AbstractPaymentMethodType {
	 ...
	 * @var string
	 */
	protected $name = 'ccat_payment_app_icash';
	...
	public function get_payment_method_script_handles(): array {
		$script_path = '/resources/js/frontend/icash.js';
		$script_url  = WC_CCat_Payments::plugin_url() . $script_path;

		wp_register_script(
			'wc-ccat-icash-payments-blocks',
			$script_url,
			array(
				'wc-blocks-registry',
				'wc-settings',
		...
		return array( 'wc-ccat-icash-payments-blocks' );
	}
