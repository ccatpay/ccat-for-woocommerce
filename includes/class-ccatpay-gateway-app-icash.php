...
class CCATPAY_Gateway_App_Icash extends CCATPAY_Gateway_App_Abstract {
	...
	public function __construct() {
		...
		$this->title       = __( '黑貓Pay - iCash Pay', WC_CCAT_PAYMENTS_DOMAIN );
		$this->description = __( '使用黑貓 iCash Pay，付款更安心。', WC_CCAT_PAYMENTS_DOMAIN );
		parent::__construct();
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'   => array(
				...
				'default'     => __( '黑貓Pay - iCash Pay', WC_CCAT_PAYMENTS_DOMAIN ),
				'desc_tip'    => true,
			),
		);
	}
