    ...
    public static function get_settings(): array
    {
        return array(
            ...
            array(
                ...
                'type' => 'checkbox',
                'desc' => __('啟用測試模式以使用黑貓Pay測試環境，關閉則使用正式環境。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_test_mode',
                'default' => 'no',
            ),
            array(
                'name' => __('金流代號', 'woocommerce-gateway-ccat'),
                'type' => 'text',
                'desc' => __('輸入您的黑貓Pay 金流代號。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_merchant_id',
            ),
            array(
                'name' => __('API密碼', 'woocommerce-gateway-ccat'),
                'type' => 'password',
                'desc' => __('輸入黑貓Pay 的 API 密碼。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_api_key',
            ),
            array(
                'name' => __('檢核碼', 'woocommerce-gateway-ccat'),
                'type' => 'password',
                'desc' => __('輸入API檢核碼(hash_base)，信用卡線上刷卡使用。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_chk_code',
            ),
            array(
                'name' => __('測試模式金流代號', 'woocommerce-gateway-ccat'),
                'type' => 'text',
                'desc' => __('測試環境用的金流代號，啟用測試模式時有效。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_test_merchant_id',
            ),
            array(
                'name' => __('測試模式 API 密碼', 'woocommerce-gateway-ccat'),
                'type' => 'password',
                'desc' => __('測試環境用的 API 密碼，啟用測試模式時有效。', 'woocommerce-gateway-ccat'),
                'id' => 'wc_ccat_test_api_key',
            ),
            array(
                'name' => __('測試模式檢核碼', 'woocommerce-gateway-ccat'),
                'type' => 'password',
                'desc' => __('測試環境用的 API 檢核碼(hash_base)，信用卡線上刷卡使用。', 'woocommerce-gateway-ccat'),
