...
class WC_Gateway_CCat_Credit_Card extends WC_Gateway_CCat_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->title = __('黑貓Pay - 信用卡', 'woocommerce-gateway-ccat');
        $this->description = __('使用黑貓Pay付款，付款更安心。', 'woocommerce-gateway-ccat');
        parent::__construct();
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('黑貓Pay - 信用卡', 'woocommerce-gateway-ccat'),
                'desc_tip' => true,
            ),
        );
    }
