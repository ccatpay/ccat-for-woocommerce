...
class WC_Gateway_CCat_App_Opw extends WC_Gateway_CCat_App_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->title = __('黑貓Pay - OPEN錢包', 'woocommerce-gateway-ccat');
        $this->description = __('使用黑貓 OPEN錢包，付款更安心。', 'woocommerce-gateway-ccat');
        parent::__construct();
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('黑貓Pay - OPEN錢包', 'woocommerce-gateway-ccat'),
                'desc_tip' => true,
            ),
        );
    }
