...
class WC_Shipping_CCat_Prepaid_Refrigerated extends WC_Shipping_CCat_Prepaid {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = __( '黑貓物流宅配 (冷藏)', 'ccat-for-woocommerce' );
		$this->title              = __( '黑貓物流宅配 (冷藏)', 'ccat-for-woocommerce' );
		$this->method_description = __( '黑貓物流(冷藏)宅配，顧客需先完成付款', 'ccat-for-woocommerce' );
	}
}
